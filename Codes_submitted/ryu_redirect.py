        ...
        if out_port != ofproto.OFPP_FLOOD:
            ...
            if eth.ethertype == ether_types.ETH_TYPE_IP:
                ...
                # TCP
                    ...
                    # redirect: client >> server_2
                    if ip_dst == server_1_ip and dst == server_1_mac:
                        match = parser.OFPMatch(eth_type=ether_types.ETH_TYPE_IP,
                                                ip_proto=ip_protocol,
                                                ipv4_src=ip_src,
                                                ipv4_dst=ip_dst,
                        ...
                        if dst in self.mac_to_port[dpid]:
                            ...
                            out_port = ofproto.OFPP_FLOOD
                        actions = [parser.OFPActionSetField(eth_dst=dst),
                                   parser.OFPActionSetField(ipv4_dst=ip_dst),
                                   parser.OFPActionOutput(port=out_port)]
                    # redirect: server_2 >> client
                    elif ip_dst == client_ip and dst == client_mac:
                        match = parser.OFPMatch(eth_type=ether_types.ETH_TYPE_IP,
                                                ip_proto=ip_protocol,
                                                ipv4_src=ip_src,
                                                ipv4_dst=ip_dst,
                        ...
                        if dst in self.mac_to_port[dpid]:
                            ...
                            out_port = ofproto.OFPP_FLOOD
                        actions = [parser.OFPActionSetField(eth_src=src),
